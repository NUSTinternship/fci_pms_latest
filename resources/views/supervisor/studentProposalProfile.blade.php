              ...
              <div class="col-sm-12">
                ...
                @if (!$proposalSummary->isEmpty())
                                ...
                                <div class="card shadow p-3 mb-5 bg-white rounded">
                                    ...
                                    <div class="alert alert-success" role="alert">
                                        <strong>
                                            ...
                                            Now Requires Approval From The HDC. <br>
                                            Evaluator's Checklist: <a
                                                href="/download/{{ $checklist->file_name }}">View</a>
                                        </strong>
                                    </div>
                            ...
                            <div class="card shadow p-3 mb-5 bg-white rounded">
                                ...
                                <div class="alert alert-success" role="alert">
                                    <strong>
                                        This Student Has Submitted Their Corrected Proposal Documents. Please Evaluate The
                                            Documents And Provide Feedback. <br>
                                        {{-- Evaluator's Checklist: <a
                                            href="/download/{{ $checklist->file_name }}">View</a> --}}
                                    </strong>
                                </div>
                                ...
                                <div class="modal fade text-center" id="approve" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                    id="proposalDocsHDCApprovalClose" data-dismiss="modal">Close</button>
                                                <button type="button" class="btn btn-primary"
                                                    id="proposalDocsHDCApproval">Submit</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="modal fade text-center" id="reject" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                    id="proposalDocsRejectionHDCClose" data-dismiss="modal">Close</button>
                                                <button type="button" class="btn btn-primary"
                                                    id="proposalDocsHDCRejection">Submit</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card shadow p-3 mb-5 bg-white rounded">
                                ...
                                <div class="alert alert-success" role="alert">
                                    <strong>
                                        You Have Approved This Student's Corrected Proposal Documents.
                                    </strong>
                                </div>
                                <div class="row">
                                    <div class="col-sm-10">
                            ...
                            <div class="card shadow p-3 mb-5 bg-white rounded">
                                ...
                                <div class="alert alert-danger" role="alert">
                                    <strong>
                                        The Student's Proposal Documents Have Been Rejected By The HOD. Please Wait For Them To
                                        Resubmit Their Documents.
                                    </strong>
                                </div>
                                <div class="row">
                            ...
                            <div class="card shadow p-3 mb-5 bg-white rounded">
                                ...
                                <div class="alert alert-success" role="alert">
                                    <strong>
                                        The HOD Has Approved This Student's Corrected Proposal Documents. The Student Is Now Awaiting Approval From The Higher Degree Committee.
                                    </strong>
                                </div>
                                <div class="row">
                                    <div class="col-sm-10">
