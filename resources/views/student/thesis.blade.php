                            ...
                            <div class="modal fade text-center" id="final" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        @else
                                            <div class="modal-body">
                                                <form id="thesis_documents" enctype="multipart/form-data" method="POST">
                                                    <div class="form-group">
                                                        ...
                                                        <label for="thesis_abstract" style="color: black;">Thesis
                                                            Abstract</label>
                                                        <input type="file" class="form-control-file" name="thesis_abstract"
                                                            id="thesis_abstract">

                                                        <label for="final_thesis" style="color: black;">Final
                                                            Thesis</label>
                                                        <input type="file" class="form-control-file" name="final_thesis"
                                                            id="final_thesis">
                                                    </div>
                                                </form>
                                            </div>
