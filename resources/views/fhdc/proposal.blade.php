...
<div class="d-flex" id="wrapper">
    ...
    <div class="border-right" id="sidebar-wrapper" style="background-color: #1b2d5d; color: white;">
        ...
        <div class="list-group list-group-flush">
          ...
          <a href="{{route('fdc-application')}}" class="list-group-item list-group-item-action text-white"><i class="fa fa-newspaper" id="icons"
              aria-hidden="true"></i>Application</a>
          <a href="{{route('fdc-proposal')}}" class="list-group-item list-group-item-action text-white active"><i class="fa fa-sticky-note"
