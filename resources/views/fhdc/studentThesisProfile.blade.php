    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-right" id="sidebar-wrapper" style="background-color: #1b2d5d; color: white;">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="{{ route('hdc-application') }}" class="list-group-item list-group-item-action text-white"><i
            ...
            <div class="row" style="padding-top: 3%;">
                <div class="col-sm-12">
                    ...
                    @if (!$intentionToSubmit->isEmpty())
                        ...
                        @if ($thesisStatus[0]->status == "Supervisor Approved")
                            <div class="card shadow p-3 mb-5 bg-white rounded">
                                ...
                                <div class="alert alert-warning" role="alert">
                                    <strong>
                                        The Student's Thesis Documents Have Been Approved By Their Supervisor. They Are Currently Awaiting Approval From The HOD.
                                    </strong>
                                </div>
                                {{-- <div class="row">
                                    <div class="col-sm-10">
                        ...
                        @elseif ($thesisStatus[0]->status == "Submitted" || $thesisStatus[0]->status == "Thesis Correction Resubmitted")
                            <div class="card shadow p-3 mb-5 bg-white rounded">
                                <h5 class="card-header">Final Thesis</h5>
                                <hr>
                                <div class="text-center">
                                ...
                                <div class="alert alert-warning" role="alert">
                                    <strong>
                                        The Student Has Submitted Their Thesis Documents. They Are Now Awaiting Approval From Their Supervsior.
                                    </strong>
                                </div>
                                {{-- <div class="row">
                                    <div class="col-sm-10">
                        ...
                        @elseif ($thesisStatus[0]->status == "HOD Rejected: Resubmit" || $thesisStatus[0]->status == "HOD Rejected: Thesis Correction Submission")
                            <div class="card shadow p-3 mb-5 bg-white rounded">
                                <h5 class="card-header">Final Thesis</h5>
                                <hr>
                                <div class="text-center">
                                ...
                                <div class="alert alert-danger" role="alert">
                                    <strong>
                                        The HOD Has Rejected This Student's Thesis Documents. The Student Will Be Required To Resubmit Their Documents.
                                    </strong>
                                </div>
                                {{-- <div class="row">
                                    <div class="col-sm-10">
                            ...
                            <div class="card shadow p-3 mb-5 bg-white rounded">
                                ...
                                <div class="alert alert-danger" role="alert">
                                    <strong>
                                        The Student's Thesis Documents Have Been Rejected By Their Supervisor. They Will Now Be Required To Resubmit Their Documents.
                                    </strong>
                                </div>
                                {{-- <div class="row">
                                    <div class="col-sm-10">
                        ...
                        <div class="card shadow p-3 mb-5 bg-white rounded">
                            ...
                            <div class="alert alert-warning" role="alert">
                                <strong>
                                    The Student Is Now In The Examination Stage.
                                </strong>
                            </div>
                            <div class="row">
                                <div class="col-sm-10">
                            ...
                            <div class="modal fade text-center" id="approve" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" id="hdcThesisDocsApprovalClose"
                                                data-dismiss="modal">Close</button>
                                            <button type="button" class="btn btn-primary"
                                                id="hdcThesisDocsApproval">Submit</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="modal fade text-center" id="reject" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"
                                                id="hdcThesisDocsRejectionClose" data-dismiss="modal">Close</button>
                                            <button type="button" class="btn btn-primary"
                                                id="hdcThesisDocsRejection">Submit</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        @elseif ($thesisStatus[0]->status == "HOD Approved: Thesis Correction Submission")
                            <div class="card shadow p-3 mb-5 bg-white rounded">
                                ...
                                <div class="alert alert-warning" role="alert">
                                    <strong>
                                        The Student's Thesis Documents Have Been Approved By The HOD. They Are Currently Awaiting Your Approval.
                                    </strong>
                                </div>
                                <div class="row">
                                    <div class="col-sm-10">
                        ...
                        @elseif ($thesisStatus[0]->status == "HDC Approved")
                            <div class="card shadow p-3 mb-5 bg-white rounded">
                                ...
                                <div class="alert alert-success" role="alert">
                                    <strong>
                                        You Have Approved The Student's Thesis Documents. The Student Has Now Moved On To The Examination Stage. WHAT NEXT?.
                                    </strong>
                                </div>
                                <div class="row">
                                    <div class="col-sm-10">
                            ...
                            <div class="card shadow p-3 mb-5 bg-white rounded">
                                ...
                                <div class="row">
                                    <div class="col-sm-10">
                                        ...
                                        Thesis Abstract <br>
                                        Final Thesis <br>
                                        Corrections Report <!-- If There Is One -->
                                    </div>
                                    <div class="col-sm-2">
                                        <a href="/download/{{ $intentionToSubmit[0]->file_name }}"><i
                                                class="fa fa-download download-icon"></i></a><br>
