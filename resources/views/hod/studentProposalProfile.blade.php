    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-right" id="sidebar-wrapper" style="background-color: #1b2d5d; color: white;">
            ...
            <div class="list-group list-group-flush">
                <a href="{{ route('hod-home') }}" class="list-group-item list-group-item-action text-white"><i
                        class="fa fa-home" id="icons" aria-hidden="true"></i>Home</a>
                <a href="{{ route('hod-proposal') }}" class="list-group-item list-group-item-action text-white active"><i
                ...
                <div class="row" style="padding-top: 3%;">
                    <div class="col-sm-12">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @endif
                                                            <!-- Modal -->
                                                            <div class="modal fade" id="assignEval" tabindex="-1"
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        @if ($student[0]->program == 'Masters')
                                                                            <div class="modal-body">
                                                                                ...
                                                                                <form>
                                                                                    @csrf
                                                                                    <label>Please select an evaluator
                                                                                        Masters:</label>
                        ...
                        @if ($studentsEligibleForEvaluator->contains('student_id', $student[0]->user_id))
                            ...
                            @elseif ($proposal_status[0]->status == 'Proposal Corrections Submitted')
                            <div class="card shadow p-3 mb-5 bg-white rounded">
                                <h5 class="card-header">Final Proposal</h5>
                                <hr>
                                    <div class="row text-center">
                            ...
                            @elseif ($proposal_status[0]->status == 'Resubmit')
                                ...
                                <div class="card shadow p-3 mb-5 bg-white rounded">
                                    ...
                                    <div class="alert alert-danger" role="alert">
                                        <strong>
                                            ...
                                            HDC Comments: {{ $proposal_status[0]->hdc_comments }}
                                        </strong>
                                    </div>
                                    <br>
                                        <div class="row">
                                ...
                                @elseif ($proposal_status[0]->status == 'HOD Rejected (Resubmission)')
                                <div class="card shadow p-3 mb-5 bg-white rounded">
                                    <h5 class="card-header">Final Proposal</h5>
                                    <hr>
                                    <div class="alert alert-danger" role="alert">
                                        <strong>
                                            You Have Rejected The Student's Corrected Proposal Documents. The Student
                                            Will Be Required To Resubmit Their Documents. <br>
                                            {{-- HOD Comments: {{ $proposal_status[0]->hod_comments }} --}}
                                        </strong>
                                    </div>
                                    <br>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <a href="/download/{{ $finalProposalFileName->file_name }}"><i
                                                        class="fa fa-download download-icon"></i></a><br>
                                                <a href="/download/{{ $correctionsFileName->file_name }}"><i
                                                    class="fa fa-download download-icon"></i></a><br>
                                                <hr>
                                                <a href="/download/{{ $checklist[0]->file_name }}"><i
                                                        class="fa fa-download download-icon"></i></a>
                            ...
                            @elseif ($proposal_status[0]->status == 'Supervisor Approved (Resubmission)')
                            <div class="card shadow p-3 mb-5 bg-white rounded">
                                <h5 class="card-header">Final Proposal</h5>
                                <hr>
                                <div class="alert alert-warning" role="alert">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                    id="proposalDocsHODApprovalClose" data-dismiss="modal">Close</button>
                                                <button type="button" class="btn btn-primary"
                                                    id="proposalDocsHODApproval">Submit</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="modal fade text-center" id="reject" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                    id="proposalDocsRejectionHODClose" data-dismiss="modal">Close</button>
                                                <button type="button" class="btn btn-primary"
                                                    id="proposalDocsHODRejection">Submit</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card shadow p-3 mb-5 bg-white rounded">
                                ...
                                <div class="alert alert-success" role="alert">
                                    <strong>
                                        You Have Approved This Student's Corrected Proposal Documents. The Student Now Awaits Approval From The Higher Degree Committee.
                                    </strong>
                                </div>
                                <br>
                                    <div class="row">
