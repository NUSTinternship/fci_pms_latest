    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-right" id="sidebar-wrapper" style="background-color: #1b2d5d; color: white;">
            ...
            <div class="list-group list-group-flush">
              ...
              <a href="{{route('hod-thesis')}}" class="list-group-item list-group-item-action text-white active"><i
            ...
            <div class="row" style="padding-top: 3%;">
                <div class="col-sm-12">
                    ...
                    @if (!$intentionToSubmit->isEmpty())
                        ...
                        @if ($thesisStatus[0]->status == "Supervisor Approved")
                                ...
                                <div class="modal fade text-center" id="approve" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" id="hodThesisDocsApprovalClose"
                                                    data-dismiss="modal">Close</button>
                                                <button type="button" class="btn btn-primary"
                                                    id="hodThesisDocsApproval">Submit</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="modal fade text-center" id="reject" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                    id="hodThesisDocsRejectionClose" data-dismiss="modal">Close</button>
                                                <button type="button" class="btn btn-primary"
                                                    id="hodThesisDocsRejection">Submit</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="modal fade text-center" id="approve" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" id="hodThesisResubmissionApprovalClose"
                                                    data-dismiss="modal">Close</button>
                                                <button type="button" class="btn btn-primary"
                                                    id="hodThesisResubmissionApproval">Submit</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="modal fade text-center" id="reject" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                    id="hodThesisResubmissionRejectionClose" data-dismiss="modal">Close</button>
                                                <button type="button" class="btn btn-primary"
                                                    id="hodThesisResubmissionRejection">Submit</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        @elseif ($thesisStatus[0]->status == "Supervisor Rejected: Resubmit" || $thesisStatus[0]->status == "Supervisor Rejected: Thesis Correction Submission")
                            <div class="card shadow p-3 mb-5 bg-white rounded">
                                <h5 class="card-header">Final Thesis</h5>
                                <hr>
                                <br>
                                <div class="alert alert-danger" role="alert">
                                    <strong>
                                        The Student's Thesis Documents Have Been Rejected By Their Supervsior. They Will Now Be Required To Resubmit Their Documents.
                                    </strong>
                                </div>
                                {{-- <div class="row">
                                    <div class="col-sm-10">
                        ...
                        @elseif ($thesisStatus[0]->status == "Submitted")
                            <div class="card shadow p-3 mb-5 bg-white rounded">
                                <h5 class="card-header">Final Thesis</h5>
                                <hr>
                                <div class="text-center">
                                ...
                                <div class="alert alert-warning" role="alert">
                                    <strong>
                                        The Student Has Submitted Their Documents. They Are Now Awaiting Approval From Their Supervsior.
                                    </strong>
                                </div>
                                {{-- <div class="row">
                                    <div class="col-sm-10">
                        ...
                        @elseif ($thesisStatus[0]->status == "Thesis Correction Resubmitted")
                            <div class="card shadow p-3 mb-5 bg-white rounded">
                                <h5 class="card-header">Final Thesis</h5>
                                <hr>
                                <div class="text-center">
                        ...
                        @elseif ($thesisStatus[0]->status == "HOD Rejected: Resubmit")
                            <div class="card shadow p-3 mb-5 bg-white rounded">
                                ...
                                <div class="alert alert-danger" role="alert">
                                    <strong>
                                        You Have Rejected The Student's Thesis Documents. Please Wait For The Student To Resubmit Their Documents.
                                    </strong>
                                </div>
                                <div class="row">
                                    <div class="col-sm-10">
                        ...
                        @elseif ($thesisStatus[0]->status == "HOD Approved")
                            <div class="card shadow p-3 mb-5 bg-white rounded">
                                ...
                                <div class="alert alert-success" role="alert">
                                    <strong>
                                        You Have Approved The Student's Thesis Documents. The Student Is Now Awaiting Examination.
                                    </strong>
                                </div>
                                <div class="row">
                                    <div class="col-sm-10">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body text-left">
                                                        <div class="alert alert-danger print-examiners-error-msg"
                                                            role="alert" style="display:none">
                                                            <strong>
                                                                <ul></ul>
                                                            </strong>
                                                        </div>
                                                        <div class="alert alert-success print-examiners-success-msg"
                                                            role="alert" style="display:none">
                                                            <strong>
                                                                Examiner's Report Submitted Successfully.
                                                            </strong>
                                                        </div>
                                                        <form id="examinersForm">
                                                            @csrf
                                                            <div class="form-group">
                                                                <label for="exampleFormControlFile1"
                                                                    style="color: black;">Examiner's Report</label>
                                                                <input type="file" name="examiners_report" id="examiners_report"
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" id="examinersReportSubmitClose"
                                                            data-dismiss="modal">Close</button>
                                                        <button type="button" class="btn btn-primary" id="examinersReportSubmit">Submit</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        @elseif ($thesisStatus[0]->status == "HOD Approved: Thesis Correction Submission")
                            <div class="card shadow p-3 mb-5 bg-white rounded">
                                ...
                                <div class="alert alert-success" role="alert">
                                    <strong>
                                        You Have Approved The Student's Thesis Documents. The Student Is Now Awaiting Approval From The HDC.
                                    </strong>
                                </div>
                                <div class="row">
                                    <div class="col-sm-10">
